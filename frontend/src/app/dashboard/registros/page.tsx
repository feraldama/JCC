        ...
        <div className="flex gap-2">
          <button
            onClick={() => exportToExcel<Registro>(
              ...
              [
                { header: "Id", value: (r) => r.RegistroId },
                { header: "Tipo Registro", value: (r) => r.RegistroTipoRegistro },
                { header: "Codigo Identificador", value: (r) => r.AlumnoCodigoIdentificador ?? "" },
                { header: "Alumno CI", value: (r) => r.AlumnoCI ?? "" },
                { header: "Alumno Nombre", value: (r) => r.AlumnoNombre ? `${r.AlumnoApellido} ${r.AlumnoNombre}` : "" },
                { header: "Tipo Comprobante", value: (r) => r.RegistroTipoComprobante },
                { header: "Fecha", value: (r) => formatFecha(r.RegistroFecha) },
                { header: "Timbrado", value: (r) => r.RegistroTimbrado },
                { header: "Nro Comprobante", value: (r) => r.RegistroNroComprobante },
                { header: "Iva10", value: (r) => Number(r.RegistroIva10) },
                { header: "Iva5", value: (r) => Number(r.RegistroIva5) },
                { header: "Iva Exento", value: (r) => Number(r.RegistroIvaExento) },
                { header: "Total", value: (r) => Number(r.RegistroTotal) },
                { header: "Codigo Condicion", value: (r) => r.RegistroCodigoCondicion },
                { header: "Moneda Extranjera", value: (r) => r.RegistroMonedaExtranjera },
                { header: "Imputa Iva", value: (r) => r.RegistroImputaIva },
                { header: "Imputa Ire", value: (r) => r.RegistroImputaIre },
